...
<title>SECRET-LET'S UNBOX NOW!</title>
<link href="https://fonts.googleapis.com/css2?family=Queenside&display=swap" rel="stylesheet">
<style>
  body {
    height: 100vh;
    display: flex;
    ...
    align-items: center;
    background: radial-gradient(circle at top, #ffb6b6, #ff5a5a);
    font-family: 'Queenside', serif;
    overflow: hidden;
  }
